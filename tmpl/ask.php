...
?>
<div class="modal-button-trigger">
...
?>
                        <div class="form-head">
                            <h4 class="asktt">Estás consultando por el artículo:
                                <strong><?php echo $c->title; ?></strong></h4>
                            <div class="th_form"><?php $images = json_decode($c->images); ?><img
                        ...
                        <!-- Name Field -->
                        <div
                            class="form-group control-group-input <?php echo $params->get('errors_position');?>">
                            <?php if(!$labels_pos): ?>
                        ...
                        <!-- Message Field -->
                        <div
                            class="form-group control-group-textarea <?php echo $params->get('errors_position');?>">
                            <?php if(!$labels_pos): ?>
                            <label
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-default"
                    data-dismiss="modal"><?php echo $params->get('btnclose');?></button>
            </div>
        </div>
    </div>
</div>
